...
dependencies {
  ...
  implementation("org.jetbrains.kotlin:kotlin-scripting-jvm-host:$embeddedKotlinVersion")
  implementation("org.jetbrains.kotlin:kotlin-main-kts:$embeddedKotlinVersion")
}
